...
public class ServletPathValidator_Test {
  ...
  @Test
  public void testValidate_withoutLaunchConfig() {
    validator = new ServletPathValidator( "/foo", validationResult );
  ...
  @Test
  public void testValidate_withoutLaunchConfig_withAsterisk() {
    validator = new ServletPathValidator( "/foo*", validationResult );
